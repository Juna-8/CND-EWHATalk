      ...
      <div className="sticky top-0 bg-white/80 backdrop-blur-md z-40 border-b border-gray-100 px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="flex items-center gap-1 p-2 bg-gray-50 rounded-full text-gray-600 hover:text-red-500 transition-colors"
          >
            <Heart size={20} className={cn(event.likes > 0 && "fill-red-500 text-red-500")} />
            <span className="text-sm font-bold">{event.likes}</span>
          </button>
