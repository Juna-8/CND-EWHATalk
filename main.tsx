...
import { Calendar, MapPin, Bookmark, ExternalLink, Heart } from 'lucide-react';
...
export default function EventCard({ event, onClick, isBookmarked, onBookmarkToggle, onLike }: EventCardProps) {
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <button
            onClick={(e) => onLike(e, event.id)}
            className="flex items-center gap-1 text-gray-400 hover:text-red-500 transition-colors p-1"
          >
            <Heart size={14} className={cn(event.likes > 0 && "fill-red-500 text-red-500")} />
